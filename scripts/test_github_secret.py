...
def test_github_secret():
    ...
    if not github_secret:
        print("❌ PYTESTE_APP_SECRET não encontrado no ambiente!")
...
if __name__ == "__main__":
    ...
    if github_success:
        ...
        print("\n⚠️  VERIFICAR CONFIGURAÇÃO DO SECRET")
        sys.exit(1)